...
// Forwarded ref so libraries like react-hook-form can register the field.
// shadcn generates this as a plain function component (React 19 ref-as-prop
// style), but this project is on React 18 where that drops the ref.
